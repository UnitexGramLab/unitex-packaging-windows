...
for Windows ([32-bit][installer32] and 64-bit) on POSIX compliant systems. NSIS (Nullsoft Scriptable
...
[installer32]: http://unitex.univ-mlv.fr/releases/latest-beta/win32/
